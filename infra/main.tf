...
resource "aws_instance" "postgres_instances_primary" {
    ...
    vpc_security_group_ids = [aws_security_group.postgres_sg_region1.id, aws_security_group.ssm_sg_region1.id,aws_security_group.allow_ssh.id]
...
resource "aws_instance" "postgres_instances_secondary" {
    ...
    vpc_security_group_ids = [aws_security_group.postgres_sg_region2.id, aws_security_group.ssm_sg_region2.id,aws_security_group.allow_ssh2.id]
    iam_instance_profile = aws_iam_instance_profile.session_manager_profile.name
